...
#registerr{
    transform: translate(-68px,-800px);
    width: 200px;
    height: 40px;
    color: white;
    background-color: #cf8811;
...
<form name="customerform" action="processing/signin_processing.php" id="customerform" onsubmit="return validateForm()" method="post">
<h3 id="parentheader">Parent Login</h3> 
 ...
 Password:   <input type="password"placeholder="Password" id='fpassword' class="login" name="fpassword" ><br> <br>
  ...
  <h4 id="newmember">New member?</h4> 
  <h4 id="newmember">Register Now</h4> 
</form>

<form name="register" action="new_parent_signup.php" id="myform1"  method="post">
<input  type="submit" class="reg"formaction="new_parent_signup.php" id='registerr' value="Have a pet? Register here">
</form>

<form name="nopetuser" action="no_pet_user.php" id="myform1"  method="post">
<input  type="submit" class="reg"formaction="no_pet_user.php" id='registerr' value="no pet? Register here">
